...
/**
 * Stores a Unix timestamp in whole seconds (`N`), so sub-second precision and the time zone are lost: a value reads
 * back in UTC. An `S` is read as a date string, as a row written in an older format holds one.
 *
