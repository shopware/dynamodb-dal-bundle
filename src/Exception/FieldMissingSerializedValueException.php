 ...
 * default to fall back on, or it serialized to nothing where a value was required, as a primary or index key
 * attribute always is. Either way nothing reached the item, and the normalizer — which runs before
 * this and would have filled it — did not.
 */
